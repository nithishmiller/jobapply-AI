...
"""
    ...
    os.remove(pdf_path)
    print("test_upload_valid_pdf: PASS")
...
def test_upload_valid_docx():
    ...
    assert data["parsed"] is True
    os.remove(docx_path)
    print("test_upload_valid_docx: PASS")
...
def test_upload_invalid_file():
    ...
    try:
        ...
        if os.path.exists(path):
            os.unlink(path)
    print("test_upload_invalid_file: PASS")
...
def test_get_cvs_parsed_entries():
    ...
    for cv in parsed_entries:
        ...
        assert d["skills"]
    print("test_get_cvs_parsed_entries: PASS")

if __name__ == "__main__":
    try:
        test_root_endpoint()
    except Exception as e:
        print(f"test_root_endpoint: FAIL - {e}")
    try:
        test_health_endpoint()
    except Exception as e:
        print(f"test_health_endpoint: FAIL - {e}")
    try:
        test_upload_valid_pdf()
    except Exception as e:
        print(f"test_upload_valid_pdf: FAIL - {e}")
    try:
        test_upload_valid_docx()
    except Exception as e:
        print(f"test_upload_valid_docx: FAIL - {e}")
    try:
        test_upload_invalid_file()
    except Exception as e:
        print(f"test_upload_invalid_file: FAIL - {e}")
    try:
        test_get_cvs_parsed_entries()
    except Exception as e:
        print(f"test_get_cvs_parsed_entries: FAIL - {e}")